...
def main():
    ...
    dist_max_4x_2x_die6 = probaspace.MixedDistributionFunction(rv_die6, rv_die6, rv_die6, rv_die6, mix_func=max)
    logging.info('dist_max_4x_2x_die6: {}'.format(probaspace.make_probability_density(dist_max_4x_2x_die6, 0., 12.5, 65)))
